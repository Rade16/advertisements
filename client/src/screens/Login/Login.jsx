...
const Login = () => {
  ...
  <div className="login__container">
    ...
    <h1 className="login__title">Вход</h1>
      ...
      <input type="password" placeholder="Пароль" className="login__form-input" 
      value={password}
        onChange={(e) => setPassword(e.target.value)}/>
      <button type="submit" className="login__form-btn">Войти</button>
      <div className="">
      <p className="login__text">Еще нет аккаунта?</p>
      <p className="login__link"><Link to="/registration" className="login__link">Зарегистрироваться</Link></p>
    </div>
    </form>
  </div>
    </div>
